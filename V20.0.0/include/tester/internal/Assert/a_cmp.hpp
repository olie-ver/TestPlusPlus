...
namespace internal {
    namespace Assert {
        ...
        inline void assertLessThanEqual(const A& a, const B& b, const char* file, const int line) {
        ...
        inline void assertGreaterThanEqual(const A& a, const B& b, const char* file, const int line) {
